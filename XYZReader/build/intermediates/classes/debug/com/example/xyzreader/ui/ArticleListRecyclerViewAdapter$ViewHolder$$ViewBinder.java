...
public class ArticleListRecyclerViewAdapter$ViewHolder$$ViewBinder<T extends com.example.xyzreader.ui.ArticleListRecyclerViewAdapter.ViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131361908, "field 'imageView'");
    target.imageView = finder.castView(view, 2131361908, "field 'imageView'");
    view = finder.findRequiredView(source, 2131361904, "field 'titleView'");
    target.titleView = finder.castView(view, 2131361904, "field 'titleView'");
